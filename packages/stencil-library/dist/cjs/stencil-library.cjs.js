...
patchBrowser().then(async (options) => {
  ...
  return index.bootstrapLazy([["njwds-alert_3.cjs",[[4,"njwds-alert",{"type":[1],"isSlim":[4,"is-slim"],"headerText":[1,"header-text"]}],[0,"njwds-banner"],[4,"njwds-button",{"variant":[1]}]]],["my-component.cjs",[[2,"my-component",{"first":[1],"middle":[1],"last":[1]}]]]], options);
});
